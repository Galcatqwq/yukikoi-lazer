...
namespace osu.Desktop.Security
{
    ...
    public partial class ElevatedPrivilegesChecker : Component
    {
        ...
        private partial class ElevatedPrivilegesNotification : SimpleNotification
        {
            ...
            {
                Text =
                    $"Running osu! as {(RuntimeInfo.IsUnix ? "root" : "administrator")} does not improve performance, may break integrations and poses a security risk. Please run the game as a normal user.";
            }
