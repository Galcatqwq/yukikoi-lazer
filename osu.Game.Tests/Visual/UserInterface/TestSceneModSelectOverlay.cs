...
namespace osu.Game.Tests.Visual.UserInterface
{
    ...
    public partial class TestSceneModSelectOverlay : OsuManualInputManagerTestScene
    {
        ...
        public void TestModSettingsOrder()
        {
            ...
            AddStep("select DT + HD + DF", () => SelectedMods.Value = new Mod[] { new OsuModDoubleTime(), new OsuModHidden() });
        ...
        public void TestCustomisationPanelAbsorbsInput([Values] bool textSearchStartsActive)
        {
            ...
            AddStep("move mouse to scroll bar",
                () => InputManager.MoveMouseTo(modSelectOverlay.ChildrenOfType<ModSelectOverlay.ColumnScrollContainer>().Single().ScreenSpaceDrawQuad.BottomLeft + new Vector2(10f, -5f)));
